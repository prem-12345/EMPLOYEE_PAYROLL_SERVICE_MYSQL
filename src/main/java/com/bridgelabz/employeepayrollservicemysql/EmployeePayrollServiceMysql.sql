# "WELCOME TO EMPLOYEE PAYROLL SERVICE MYSQL"
 ...
 # "UC10 - MAKE TERISSA AS A PART OF SALES AND MARKETING DEPARTMENT"
 insert into employee_payroll(ID,NAME,GENDER,PHONE_NUMBER,ADDRESS,DEPARTMENT,SALARY,BASIC_PAY,DEDUCTIONS,TAXEBLE_PAY,INCOME_TAX,NET_PAY,START)values(6,'TERISSA','F',85965469,'GOA','SALES',10000.00,10000.00,2000.00,1000.00,2000.00,8000.00,'2020-06-01'),(7,'TERISSA','F',85965469,'GOA','MARKETING',10000.00,10000.00,2000.00,1000.00,2000.00,8000.00,'2020-06-01');
